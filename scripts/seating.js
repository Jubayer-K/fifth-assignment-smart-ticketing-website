...
for (const button of allSeatButton) {
  button.addEventListener("click", function (event) {
    ...
    div.appendChild(p2)
    div.appendChild(p3)
    div.classList.add('flex','justify-between','border-b-2','border-[#03071233]','py-4','font-normal','text-[#03071299]','text-base')
   ...
   const finalPrice = document.getElementById("grand-total").innerText = grandTotal+550;

   document.getElementById('btn-apply').addEventListener('click',function (){
    document.getElementById("grand-total").innerText = finalPrice-(totalPrice*0.15);
